...
namespace SIR.Visualizer
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Generando simulaciones para el gif 200x200 a 365 dias...");
            ...
            Console.WriteLine($"Grafica guardada: {speedupPath}");
        ...
        static void AvanzarDia(EstadoCelda[,] actual, EstadoCelda[,] siguiente,
            int filas, int columnas, double beta, double gamma, double mu, Random numeroRandom)
        {
            for (int f = 0; f < filas; f++)
            {
                for (int c = 0; c < columnas; c++)
                    ...
                    switch (estado)
                    {
                        case EstadoCelda.Susceptible:
                            ...
                            if (vecinos > 0)
                            {
                                ...
                                siguiente[f, c] = numeroRandom.NextDouble() > probSegura
                        ...
                        case EstadoCelda.Infectada:
                            double r = numeroRandom.NextDouble();
                            if (r < mu)
        ...
        static void GenerarSpeedup(string path)
        {
            ...
            int margenIzq = 70, margenDer = 30, margenArriba = 30, margenAbajo = 50;
            int areaAncho = ancho - margenIzq - margenDer;
            int areaAlto = alto - margenArriba - margenAbajo;
            ...
            using (var img = new Image<Rgba32>(ancho, alto))
            {
                ...
                // eje
                DibujarLinea(img, margenIzq, margenArriba, margenIzq, alto - margenAbajo, new Rgba32(0, 0, 0));
